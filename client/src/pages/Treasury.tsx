    ...
    <div className="min-h-screen bg-background text-foreground p-4 md:p-8 relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto relative z-10 space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            <TerminalCard title={`Tokens Bought Back`} delay={0} highlight>
              <div className="space-y-4">
                <div className="flex items-start justify-between">
                  <div className="space-y-3">
                    <div>
                      <p className="text-[10px] font-mono text-muted-foreground uppercase tracking-wider">SOL Deployed</p>
                      <p className="text-2xl font-display text-primary tracking-wide" data-testid="text-buyback-sol">
                        {formatSol(buybackSol)}
                      </p>
                    </div>
                    <div>
                      <p className="text-[10px] font-mono text-muted-foreground uppercase tracking-wider">${symbol} Acquired</p>
                      <p className="text-xl font-display text-secondary tracking-wide" data-testid="text-buyback-tokens">
                        {buybackTokens.toLocaleString()}
                      </p>
                    </div>
                    <div>
                      <p className="text-[10px] font-mono text-muted-foreground uppercase tracking-wider">USD Value</p>
                      <p className="text-lg font-mono text-foreground/80" data-testid="text-buyback-usd">
                        {formatUsd(buybackUsd)}
                      </p>
                    </div>
                  </div>
                ...
                <div className="flex items-start justify-between">
                  <div className="space-y-3">
                    <div>
                      ...
                      <p className="text-2xl font-display text-accent tracking-wide" data-testid="text-burned-tokens">
                        {burnedTokens.toLocaleString()}
                      </p>
                    </div>
                    <div>
                      <p className="text-[10px] font-mono text-muted-foreground uppercase tracking-wider">USD Value</p>
                      <p className="text-xl font-mono text-foreground/80" data-testid="text-burned-usd">
                        {formatUsd(burnedUsd)}
                      </p>
                    </div>
                ...
                <div className="flex items-start justify-between">
                  <div className="space-y-3">
                    <div>
                      ...
                      <p className="text-2xl font-display text-secondary tracking-wide" data-testid="text-rewards-usd">
                        {formatUsd(rewardsUsd)}
                      </p>
                    </div>
                    <div>
                      <p className="text-[10px] font-mono text-muted-foreground uppercase tracking-wider">Active Campaigns</p>
                      <p className="text-xl font-display text-primary tracking-wide" data-testid="text-active-campaigns">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 font-mono text-sm">
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground text-xs leading-relaxed">
                Treasury deploys SOL to acquire ${symbol} tokens from the open market, reducing circulating supply and supporting price.
              </p>
            </div>
            <div className="space-y-2">
